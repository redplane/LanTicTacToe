...
namespace ServiceLayer.Helpers
{
    ...
    internal class MainHelper
    {
        ...
        /// <summary>
        /// This list stores clients connected to server.
        /// </summary>
        public List<ClientInfo> Clients { get; set; }

        /// <summary>
        /// Get/set whether game has been started or not.
        /// </summary>
        ...
        /// <summary>
        /// Initialize an object of MainHelper with no input parameter.
        /// </summary>
        public MainHelper()
        {
            // Initialize a list of client.
